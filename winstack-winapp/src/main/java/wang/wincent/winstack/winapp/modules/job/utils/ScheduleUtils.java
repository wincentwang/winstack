package wang.wincent.winstack.winapp.modules.job.utils;
...
public class ScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new WinException("getCronTrigger异常，请检查qrtz开头的表，是否有脏数据", e);
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJobEntity scheduleJob) {
        try {
            ...
            throw new WinException("创建定时任务失败", e);
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJobEntity scheduleJob) {
        try {
            ...
            throw new WinException("更新定时任务失败", e);
        }
    }
    ...
    public static void run(Scheduler scheduler, ScheduleJobEntity scheduleJob) {
        try {
            ...
            throw new WinException("立即执行定时任务失败", e);
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new WinException("暂停定时任务失败", e);
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new WinException("删除定时任务失败", e);
        }
    }
}
